-- questmarks DAT name tables -- GENERATED FILE, DO NOT EDIT BY HAND.
-- Regenerate: luajit tools/pipeline/dump_res.lua --names --dat-source <dir>
--
-- names[cat][area][id] = the quest/mission name the CLIENT uses, read
-- out of the game's own DAT files (0xD99A-0xD9BE). This is game data, not
-- wiki data -- see NOTICE. Frozen: nothing in questmarks needs an extractor
-- unless the game adds content.
--
-- Load-bearing beyond labelling: core/quests.lua feeds these ids to
-- state.set_area_ids, and resolve_linear picks the largest id <= the packet
-- pointer. A missing id silently drags a linear storyline backwards, so this
-- table must stay COMPLETE regardless of which quests have wiki coverage.
-- 1987 names.
